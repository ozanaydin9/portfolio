                ...
                <Content>
                    ...
                    <div className="contentdiv1">
                        ...
                        <bg className="buttons">
                            ...
                            <Tooltip title="twitter.com/ozanjs">
                                <Button onClick={() => window.open( 'http://www.twitter.com/ozanjs')} style={{ width:60, height:60, margin:50 }} type="link" ghost size="large" shape="circle"> {iconTwitter} </Button>
                            </Tooltip>
